...
def MakeKerasConv1DTranspose(layer):
    """
    Create a Keras-compatible 1D transposed convolutional layer operation using SOFIE.
    """
    ...
    if fKerasPadding == "valid":
        ...
        raise RuntimeError(
            "TMVA::SOFIE - RModel Keras Parser doesn't yet supports Conv1DTranspose padding " + fKerasPadding
        )
    ...
    if SOFIE.ConvertStringToType(fLayerDType) == SOFIE.ETensorType.FLOAT:
        ...
        raise RuntimeError("TMVA::SOFIE - Unsupported type for Conv1DTranspose: " + fLayerDType)
